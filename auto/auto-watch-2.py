...
if apps:
    ...
    for window in window_list:
        if window.get(CG.kCGWindowOwnerName, '') == app_name:
            ...
            found_windows.append({'x': x, 'y': y, 'width': width, 'height': height, 'kCGWindowOwnerPID': kCGWindowOwnerPID, 'kCGWindowName': kCGWindowName})
    ...
    for window in found_windows:
        ...
        kCGWindowOwnerPID = window['kCGWindowOwnerPID']
        kCGWindowName = window['kCGWindowName']
    ...
    print("Đã xem xong tất cả các kênh trên tất cả các cửa sổ")
