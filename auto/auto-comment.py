...
if app:
    ...
    for window in window_list:
        if window.get(CG.kCGWindowOwnerName, '') == app_name:
                ...
                for i in range(3):
                    ...
                    try:
                        ...
                        if image_location is not None:
                            ...
                            print('Click vào vị trí của hình ảnh của icon comment')
                            # Di chuyển chuột đến vị trí của hình ảnh
                            pyautogui.moveTo(image_center)
                            # click vào vị trí của hình ảnh
                            # pyautogui.click(image_center)
                        else:
                            print("Không tìm thấy hình ảnh comment trên màn hình")

                    except Exception as e:
                        print(f"Có lỗi xảy ra ở icon comment: {e}")


                    exit()

                    # click vào vị trí add comment
                    try:
                        # Tìm vị trí của hình ảnh trên màn hình
                        # Thay 'ten_hinh_anh.png' bằng đường dẫn đến file hình ảnh của bạn
                        image_location = pyautogui.locateOnScreen('./images/add-comment.png', confidence=0.8)
                        ...
                        if image_location is not None:
                            ...
                            # Click vào vị trí của hình ảnh
                            print('Click vào vị trí của hình ảnh của icon add comment')
                            pyautogui.click(image_center)
                        else:
                            print("Không tìm thấy hình ảnh add comment trên màn hình")

                    except Exception as e:
                        print(f"Có lỗi xảy ra ở icon add comment: {e}")
                        exit()

                    # nhập comment
                    pyautogui.typewrite('funny')

                    # click vào vị trí send comment
                    try:
                        # Tìm vị trí của hình ảnh trên màn hình
                        # Thay 'ten_hinh_anh.png' bằng đường dẫn đến file hình ảnh của bạn
                        image_location = pyautogui.locateOnScreen('./images/send-comment.png', confidence=0.8)
                        ...
                        if image_location is not None:
                            ...
                            # Click vào vị trí của hình ảnh
                            print('Click vào vị trí của hình ảnh của icon send comment')
                            pyautogui.click(image_center)
                        else:
                            print("Không tìm thấy hình ảnh send comment trên màn hình")

                    except Exception as e:
                        print(f"Có lỗi xảy ra ở icon send comment: {e}")
                        exit()
            ...
            break
    print("Đã add comment xong tất cả các kênh")
